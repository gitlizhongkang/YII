        ...
        function C(c, A, v) {
            ...
            if ("undefined" != typeof document) {
                if (arguments.length > 1) {
                    ...
                    C.defaults, v), "number" == typeof v.expires) {
                        var h = new Date;
                        h.setMilliseconds(h.getMilliseconds() + 864e5 * v.expires),
                        v.expires = h
                    }
                    try {
                        w = JSON.stringify(A),
                    ...
                    return A = g.write ? g.write(A, c) : encodeURIComponent(String(A)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent),
                    c = encodeURIComponent(String(c)),
                    c = c.replace(/%(23|24|26|2B|5E|60|7C)/g, decodeURIComponent),
                    c = c.replace(/[\(\)]/g, escape),
                    document.cookie = [c, "=", A, v.expires ? "; expires=" + v.expires.toUTCString() : "", v.path ? "; path=" + v.path: "", v.domain ? "; domain=" + v.domain: "", v.secure ? "; secure": ""].join("")
                }
                c || (w = {});
...
function() {
    // function a(e) {
    //     for (var a = e.target || e.srcElement,
    //     C = []; a && a.getAttribute && !a.getAttribute("data-lg-tj-id") && !a.getAttribute("data-lg-gatj-msg");) a = a.parentNode;
    //     if (a && a.getAttribute) try {
    //         A = (a.getAttribute("data-lg-tj-id") || "idnull").trim(),
    //         v = (a.getAttribute("data-lg-tj-no") || "idnull").trim(),
    //         h = (a.getAttribute("data-lg-tj-cid") || "idnull").trim(),
    //         b = g(),
    //         k = (a.getAttribute("data-lg-tj-abt") || "").trim();
    ...
    //             I = I.parentNode
    //         }
    //         Cookies.get("TG-TRACK-CODE") && "" != Cookies.get("TG-TRACK-CODE") ? 1 == N && _ && Cookies.set("TG-TRACK-CODE", _, {
    //             path: "/"
    //         }) : _ && Cookies.set("TG-TRACK-CODE", _, {
    //             path: "/"
    //         });
    ...
    //         var M = {};
    //         M.v = y,
    //         M.t = a.tagName.toLocaleLowerCase(),
    //         M.dl = encodeURIComponent(T),
    //         M.dr = encodeURIComponent(O),
    //         M.dt = S,
    //         M.aid = [A, v, w, h, b].join("_"),
    //         !!k && "|" != k && (M.abt = k),
    //         !!U && "" != U && (M.intrack = U),
    //         c(M)
    //     } catch(e) {}
    ...
    function g(a) {
        ...
        for (var g = window._CASH_RANDOM || {},
        C = a || 4,
        A = c(); g[A] && (A = c(), g[A]););
        return window._CASH_RANDOM[A] = A,
        A
    }
    var C = {
    ...
    S = document.title,
    I = document;
    I.addEventListener ? I.addEventListener("click", a, !0) : I.attachEvent && I.attachEvent("onclick", a),
