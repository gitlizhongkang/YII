...
function getStrLen(a) {
    ...
    b += isDbcCase(d) ? 1 : 2;
>>>>>>> 1deaffac9997efc744b5ba89fcc657be7014f81b
    return b
}
...
$(function() {
    function a() {
        var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o,r;
        var tag=$('#jobForm input[name="tag_cn[]"]');
        var p='';
        for(var i=0;i<tag.length;i++){
            if(tag.eq(i).prop('checked')){
                p+=','+tag.eq(i).val();
            }
        };
        p=p.substr(1);
        var require=$('#jobForm input[name="require[]"]');
        var q='';
        for(var i=0;i<require.length;i++){
            if(require.eq(i).prop('checked')){
                q+=','+require.eq(i).val();
            }
        };
        q=q.substr(1);
        $("#jobForm").valid() && ( a = $("#positionType").val(), 
            b = $("#positionName").val(), 
            c = $('#jobForm input[name=nature_cn]:checked').val(), 
            d = $('#jobForm input[name="sex_cn"]:checked').val(), 
            e = $("#salaryMin").val(), f = $("#salaryMax").val(), 
            g = $("#wage_cn").val(), h = $("#province").val(), 
            i = $("#city").val(), j = $("#place").val(), 
            k = $("#experience").val(), l = $("#education").val(), 
            m = $("#amount").val(), n = $("#positionDetail").val(), 
            o = $("#education_id").val(),
            r=$('#positionAddress').val(),
            $.ajax({
            url: "",
            type: "POST",
            data: {
