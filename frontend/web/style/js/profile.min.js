...
!function (a, b) {
    ...
    function e() {
        $(".projectForm").each(function () {
            $(this).validate({
                ...
                rules: {
                    projectName: { maxlenStr: 100},
                    thePost: { maxlenStr: 100},
                    projectYearStart: { checkProjectYear: !0},
                    projectMonthStart: { checkProjectYear: !0},
                    projectYearEnd: { checkProjectYear: !0},
                    projectMonthEnd: {
                        required: function () {
                ...
                submitHandler: function (a) {
                    ...
                    $(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
                        ...
                        if(map.done == 1)
                        {
                            ...
                            window.location.href = updateUrl + '&id=' + map.id
                        }
                    })
                }
            })
    ...
    window.onbeforeunload = function () {
        ...
        $(this).attr("checked",true).parent("li").siblings("li").removeClass("current").find("input").attr("checked",false), $(this).attr("checked",false).parent("li").addClass("current").find("input").attr("checked",true)
    ...
    $("#resume_name .nameShow .rename").bind("click", function () {
        ...
        var a = $("#nameVal").val(), b = $("#genderVal").val(), bb = $("#marriageVal").val(), c = $("#topDegreeVal").val(), d = $("#workyearVal").val(), e = $("#currentStateVal").val(), f = $("#emailVal").val(), g = $("#telVal").val();
        $("#name").val(a),$('input[name="se"]').val(b), $('input[name="marr"]').val(bb),$('#basicInfo .profile_radio li input[value="' + b + '"] , #basicInfo .profile_radio li input[value="' + bb + '"]').attr("checked", true).parent("li").addClass("current").siblings("li").removeClass("current"), $("#topDegree").val(c), $("#select_topDegree").val(c).css("color", "#333"), $("#workyear").val(d), $("#select_workyear").val(d).css("color", "#333"), "" != e && ($("#currentState").val(e), $("#select_currentState").val(e).css("color", "#333")), $("#email").val(f), $("#tel").val(g), $("#portraitShow img").attr("src", $("#basicInfo .basicShow img").attr("src")), $("#portraitNo").hide(), $("#portraitShow").show(), $(this).addClass("dn"), $("#basicInfo .basicShow").addClass("dn"), $("#basicInfo .basicEdit").removeClass("dn"), j($("#basicInfo"))
        ...
        submitHandler: function (a) {
            var b = $('input[name="name"]', a).val(),
                c = $('input[name="photo_id"]', a).val(),
                d = $('input[name="se"]', a).val(),
                e = $('input[name="height"]', a).val(),
                f = $('input[name="marr"]', a).val(),
                g = $('input[name="birthday"]', a).val(),
                h = $('input[name="education"]', a).val(),
                i = $('input[name="experience"]', a).val(),
                j = $('input[name="tel"]', a).val(),
                k = $('input[name="email"]', a).val(),
                x = $('input[name="title"]').val(),
                z = $('select[name="province_id"]').val(),
                y = $('select[name="city_id"]').val(),
        ...
        $(this).validate({
            ...
            rules: {
                companyName: { maxlenStr: 100},
                positionName: { maxlenStr: 100},
                companyYearStart: { checkWorkYear: !0},
                companyMonthStart: { checkWorkYear: !0},
                companyYearEnd: { checkWorkYear: !0},
                companyMonthEnd: {
                    required: function () {
        ...
        obj: $("#projectExperience"), resetForm: function () {
            ...
            this.obj.children(".projectEdit").find(".thePost").val(""), this.obj.children(".projectEdit").find(".projectYearStart").val(""),
