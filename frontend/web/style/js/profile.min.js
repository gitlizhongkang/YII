...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        $("#name").val(a), $('#basicInfo .profile_radio li input[value="' + b + '"] , #basicInfo .profile_radio li input[value="' + bb + '"]').attr("checked", true).parent("li").addClass("current").siblings("li").removeClass("current"), $("#topDegree").val(c), $("#select_topDegree").val(c).css("color", "#333"), $("#workyear").val(d), $("#select_workyear").val(d).css("color", "#333"), "" != e && ($("#currentState").val(e), $("#select_currentState").val(e).css("color", "#333")), $("#email").val(f), $("#tel").val(g), $("#portraitShow img").attr("src", $("#basicInfo .basicShow img").attr("src")), $("#portraitNo").hide(), $("#portraitShow").show(), $(this).addClass("dn"), $("#basicInfo .basicShow").addClass("dn"), $("#basicInfo .basicEdit").removeClass("dn"), j($("#basicInfo"))
