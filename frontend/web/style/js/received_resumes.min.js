...
$(function () {
    $("#filter_btn").bind("click", function () {
        ...
        var a = $(this), b = a.parents("li").attr("data-id");
        return confirm("确定要删除该简历吗？") ? ($.ajax({
               ...
               a.msg==1 ? top.location.href = top.location.href : alert(a.msg)
            }), void 0) : !1
    ...
    }),  $(".daiding").bind("click", function () {
        var aa = $(this).attr("data-deliverId");
        window.confirm("确定要标记选中的简历为待定简历吗？确认后系统将放至待定简历") ? ($.ajax({
                type: "POST",
                url: daiding,
                data: {deliverIds: aa},
                dataType: "json"
                ...
                if(a.msg==1){
                    for(var i=0;i<$(".onlineResume").length;i++){
                        if($(".onlineResume").eq(i).attr("data-id")==aa){
                            $(".onlineResume").eq(i).remove();
                        }
                    }
                }else{
                    alert(a.msg)
        ...
        $('#refuseMailForm input[name="deliverId"]').val(a),
           $("#refuseMailForm textarea").removeClass("error").removeClass("valid"), $("#refuseMailForm span.error").remove(), $.colorbox({
                inline: !0,
                href: $("#confirmRefuse"),
                title: "确认简历不合适"
            })
        ...
        submitHandler: function (a) {
            ...
            $.ajax({
                ...
                if(a.msg==1){
                    ...
                    for(var i=0;i<$(".onlineResume").length;i++){
                        if($(".onlineResume").eq(i).attr("data-id")==c){
                            $(".onlineResume").eq(i).remove();
                        }
                    }
                }else{
        ...
        var  d = $(this).attr("data-deliverId");a=$(this).attr("email");c=$(this).attr('name');e=$(this).attr("jobname");f=$(this).attr("companyname");g=$(this).attr("rjid");
        $('#noticeInterview input[name="email"]').val(a),$('#noticeInterview input[name="name"]').val(c),$('#noticeInterview input[name="positionName"]').val(e),$('#noticeInterview input[name="companyName"]').val(f),$('#noticeInterview input[name="resumejobId"]').val(g),$('#noticeInterview input[name="deliverId"]').val(d),$('#noticeInterview input[name="subject"]').removeClass("error").removeClass("valid"), $('#noticeInterview input[name="interAdd"]').removeClass("error").removeClass("valid"), $('#noticeInterview input[name="linkPhone"]').removeClass("error").removeClass("valid"),$("#noticeInterview span.error").remove(), $.colorbox({
                    inline: !0,
